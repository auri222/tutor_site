      ...
      <section className="rTContainer">
        <div className="container">
          <div className="rTCWrapper">
            <h2 className="rTCTitle">Đăng ký khóa học tìm gia sư {tutor}</h2>
            <hr />
            {user?._id ? (
              <form className="rTCForm">
                ...
                <div className="row">
                  <div className="col-md-3">
                    <h4 className="rTCFPartTitle">Chi tiết khóa học</h4>
                  </div>
                ...
                <div className="row">
                  <div className="col-md-3">
                    <h4 className="rTCFPartTitle">Địa chỉ khóa học</h4>
                  </div>
                  <div className="col-md-9">
                    <div className="mb-3">
                      <div className="row">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="row mb-2">
                        <div className="col-md-12">
                          ...
                          <div>
                            <small>Bạn sẽ không cần phải điền thông tin địa chỉ cho khóa học nếu chọn tùy chọn này.</small>
                          </div>
